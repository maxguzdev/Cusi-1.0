   ...
   <section class="cocina">
      <div class="botones">
         <button onclick="irA('php/living.php')" class="arrow_l"><img src="/CUSI-1.0/frontEnd/Cusi_style/left.png" width="70"></button>
         <button onclick="irA('php/baño.php')" class="arrow_r"><img src="/CUSI-1.0/frontEnd/Cusi_style/right.png" width="70"></button>
